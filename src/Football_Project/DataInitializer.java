...
public class DataInitializer {
    ...
    static Team tottenham = new Team("Tottenham Hotspur", 4);
    static Team bilbao = new Team("Athletic Bilbao", 5);
    static Team frankfurt = new Team("Eintracht Frankfurt", 6);
    static Team roma = new Team("AS Roma", 7);
    static Team lyon = new Team("Olympique Lyon", 8);
    static Team nice = new Team("OGC Nice", 9);
    static Team prag = new Team("SK Slavia Prag", 10);
    static Team anderlecht = new Team("RSC Anderlecht", 11);
    static Team paok = new Team("PAOK", 12);
    static Team Midtjylland = new Team("FC Midtjylland", 13);
    static Team gilloise = new Team("Union Saint-Gilloise", 14);
    static Team twente = new Team("FC Twente Enschede", 15);
    static Team plzen = new Team("FC Viktoria Plzen", 16);
    static Team razgrad = new Team("Ludogorets Razgrad", 17);
    static Team glint = new Team("Glint", 18);
    static Team elfsborg = new Team("IF Elfsborg", 19);
    static Team karabag = new Team("Qarabağ FK", 20);
    static Team rfs = new Team("FC RFS", 21);
    static Team manu = new Team("Manchester United", 22);
    static Team sociedad = new Team("Real Sociedad", 23);
    static Team porto = new Team("FC Porto", 24);
    static Team lazio = new Team("SS Lazio", 25);
    static Team ajax = new Team("Ajax Amsterdam", 26);
    static Team hoffenheim = new Team("TSG 1899 Hoffenheim", 27);
